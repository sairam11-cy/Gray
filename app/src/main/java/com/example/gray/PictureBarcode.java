...
public class PictureBarcode extends AppCompatActivity{
   ...
   //public void onClick(View v) {
     //   switch (v.getId()) {
       //     case R.id.btnTakePicture:
         //       ActivityCompat.requestPermissions(PictureBarcode.this, new
    ...
    private void takeBarcodePicture() {
        ...
        imageUri = FileProvider.getUriForFile(PictureBarcode.this,
