        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intentData.length() > 0) {
                    if (isEmail)
                        startActivity(new Intent(ScannedBarcode.this, Email.class).putExtra("email_address", intentData));
                    else {
...
//                Toast.makeText(getApplicationContext(), "To prevent memory leaks barcode scanner has been stopped", Toast.LENGTH_SHORT).show();
    ...
    public void bring(View view) {Intent i=new Intent(ScannedBarcode.this,searchactivity.class);
        String s=txtBarcodeValue.getText().toString();
        i.putExtra("Name",s);
        startActivity(i);
    }
}